...
class StripeWebhook(Resource):
    def post(self):
        ...
        endpoint_secret =  "whsec_b3XViJJNcWJYkt4eTvV7Ptqtm9fhgMRj"# or from .env
        ...
        if event["type"] == "checkout.session.completed":
            ...
            if booking_id and user_id:
                ...
                if booking:
                    ...
                    booking.advance_payment=500
                    booking.remaining_cash=booking.total_amount-booking.advance_payment
                    db.session.commit()
